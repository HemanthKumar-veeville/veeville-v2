  ...
  return (
    <RouteTransition>
      ...
      <section className="stamina-banner">
        <img
          src={`${API_BASE_URL}/uploads/Top_d2a4b5649e.webp`}
          alt="Banner Image"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src={`${API_BASE_URL}/uploads/Mid_1_4dde4795bc.webp`}
            alt="Floral Cups"
      ...
      <section className="image-banner Middl-Sap">
        <div className="image-wrapper">
          <img
            src={`${API_BASE_URL}/uploads/Mid_2_ce0f77f780.webp`}
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-datas">
        <div className="project-datas__column project-datas__image">
          <img
            src={`${API_BASE_URL}/uploads/Bottom_1_a859e4155b.webp`}
            alt="Butterfly Cup"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src={`${API_BASE_URL}/uploads/Mid_3_a3898dc48b.webp`}
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-intro">
        ...
        <div className="project-intro__column project-intro__image">
          <img
            src={`${API_BASE_URL}/uploads/Bottom_2_e2dcf8175e.webp`}
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src={`${API_BASE_URL}/uploads/Mid_4_b6b0a9ae3b.webp`}
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src={`${API_BASE_URL}/uploads/Bottom_3_49316c854e.webp`}
        ...
        <div className="project-images__column">
          <img
            src={`${API_BASE_URL}/uploads/Bottom_4_11a465c754.webp`}
