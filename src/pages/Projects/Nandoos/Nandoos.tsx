...
const Nandoos: React.FC = () => {
  ...
  const { isHidden, isNearFooter } = useStickyBar({
    stickyDataId: "stickyData",
    ...
    <RouteTransition>
      ...
      <div>
        ...
        <section className="stamina-banner">
          <img
            src={`${API_BASE_URL}/uploads/Banner_Nandoos_da81defbec.webp`}
            alt="Banner Image"
        ...
        <section className="image-banner">
          <div className="image-wrapper">
            <img
              src={`${API_BASE_URL}/uploads/Middle_1_f49276e343.webp`}
              alt="Floral Cups"
        ...
        <section className="project-images">
          <div className="project-images__column">
            <img
              src={`${API_BASE_URL}/uploads/Left_1_9b1032672c.webp`}
          ...
          <div className="project-images__column">
            <img
              src={`${API_BASE_URL}/uploads/Right_1_b6a2482285.webp`}
        ...
        <section className="image-banner">
          <div className="image-wrapper">
            <img
              src={`${API_BASE_URL}/uploads/Middle_2_daba43142a.webp`}
              alt="Floral Cups"
              className="banner-img"
            />
          </div>
        ...
        <section className="image-banner Nandoos-middle">
          <div className="image-wrapper">
            <img
              src={`${API_BASE_URL}/uploads/Middle_3_e811ba71fd.webp`}
              alt="Floral Cups"
              className="banner-img"
            />
          </div>
        ...
        <section className="section-datas">
          <div
            ...
            style={{
              ...
              pointerEvents: isNearFooter ? "none" : "all",
            }}
          >
            ...
            <Link to="/work#Campaigns" className="sticky-card">
              <span className="sticky-data-text">Nandoos</span>
            </Link>
