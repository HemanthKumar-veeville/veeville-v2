  ...
  return (
    <>
      ...
      <section className="stamina-banner">
        <img
          src="http://localhost:1337/uploads/banner_96c2c7f51e.webp"
          alt="Banner Image"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image_5f41fed6da.webp"
            alt="Floral Cups"
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image_656e16aaf0.webp"
        ...
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_imnage_2_f9801c8a1c.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image2_9eaad90993.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image3_1af74a5b4f.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-navigation-section">
        ...
        <div className="project-navigation">
          <Link to="/projects/revolutionari" className="prev-project">
            Previous Project
          </Link>
          <Link to="/work#Campaigns" className="Categories-data">
            <span className="branding-title">Campaigns</span>
          </Link>
          <Link to="/projects/decathalon" className="next-project">
            Next Project
          </Link>
        </div>
      </section>
      ...
      <section className="section-datas">
        <div className="sticky-data" id="stickyData">
          <div className="icon-wrapper left-icon">
            <Link to="/projects/revolutionari">
