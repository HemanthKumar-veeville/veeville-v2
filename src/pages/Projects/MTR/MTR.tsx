  ...
  return (
    <>
      ...
      <section className="stamina-banner">
        <img
          src="http://localhost:1337/uploads/banner_image_30e24d56c0.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middleimage1_2fe94b39a3.webp"
            alt="Floral Cups"
      ...
      <section className="project-intro">
        ...
        <div className="project-intro__column project-intro__image">
          <img
            src="http://localhost:1337/uploads/layout_image_3_61abf10b03.webp"
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image1_1b7d19d123.webp"
        ...
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image_2_e75b130e75.webp"
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image4_990b70be69.webp"
            alt="Design Concept 1"
            className="project-images__img"
          />
        </div>
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image5_76c746983f.webp"
            alt="Design Concept 2"
            className="project-images__img"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middleimage2_07a2e9168e.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="section-datas">
        <div
          className={`sticky-data ${window.scrollY <= 20 ? "hidden" : ""}`}
          id="stickyData"
        >
