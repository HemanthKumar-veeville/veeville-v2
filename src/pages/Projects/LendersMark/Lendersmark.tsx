...
import "./Lendersmark.css";

const Lendersmark: React.FC = () => {
  useEffect(() => {
    ...
    const setupSearch = () => {
      ...
      const handleSearchClick = (e: MouseEvent) => {
        if (e.target === searchOverlay && searchOverlay) {
  ...
  return (
    <>
      ...
      <section className="stamina-banner">
        <img
          src="http://localhost:1337/uploads/LM_Banner_7237a6c83b.webp"
          alt="Banner Image"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/Midlle_LM_1_40fcce3c37.webp"
            alt="Floral Cups"
      ...
      <section className="project-datas">
        <div className="project-datas__column project-datas__image">
          <img
            src="http://localhost:1337/uploads/Left_LM_1_1794fb5456.webp"
            alt="Butterfly Cup"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/M_Iddle_LM_2_efe6a6a5af.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-intro">
        ...
        <div className="project-intro__column project-intro__image">
          <img
            src="http://localhost:1337/uploads/Right_LM_2_c8101d4480.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/Middle_LM_3_8c5f94d551.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-navigation-section">
        ...
        <div className="project-navigation">
          ...
          <Link to="/projects/mtr" className="next-project">
            Next Project
          </Link>
        </div>
      </section>
