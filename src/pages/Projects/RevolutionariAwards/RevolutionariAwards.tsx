...
import "./Revolutionari Awards.css";

const RevolutionariAwards: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="stamina-banner">
        <img
          src={`${API_BASE_URL}/uploads/RE_Awards_Banner_d1871f8d5a.webp`}
          alt="Banner Image"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src={`${API_BASE_URL}/uploads/RE_Middle_4bb4e1ea92.webp`}
            alt="Floral Cups"
      ...
      <section className="project-intro">
        ...
        <div className="project-intro__column project-intro__image">
          <img
            src={`${API_BASE_URL}/uploads/Revolutionari_Awards_logo_eebee18e80.gif`}
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src={`${API_BASE_URL}/uploads/RE_Awards_side2_b870c53ddd.webp`}
        ...
        <div className="project-images__column">
          <img
            src={`${API_BASE_URL}/uploads/RE_Awards_side3_f8b9c5f0b5.webp`}
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src={`${API_BASE_URL}/uploads/RE_Awards_side4_c6afa9d9ef.webp`}
            alt="Design Concept 1"
            className="project-images__img"
          />
        </div>
        <div className="project-images__column">
          <img
            src={`${API_BASE_URL}/uploads/RE_awards_side5_dece46c3b5.webp`}
            alt="Design Concept 2"
            className="project-images__img"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src={`${API_BASE_URL}/uploads/RE_Middle1_9100d60ad9.webp`}
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-navigation-section">
        ...
        <div className="project-navigation">
          <Link to="/projects/sn" className="prev-project">
            Previous Project
          </Link>
...
export default RevolutionariAwards;
