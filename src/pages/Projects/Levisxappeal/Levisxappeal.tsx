...
import "./Levisxappeal.css";
import ScrollToTop from "../../../components/ui/ScrollToTop";
import RouteTransition from "../../../components/ui/RouteTransition";

const LevisxappealPage: React.FC = () => {
  useEffect(() => {
      ...
      const handleScroll = () => {
        if (window.scrollY > 50) {
          ...
          navLinks.forEach((link) =>
            (link as HTMLElement).classList.add("sticky-link")
          );
          hamburgerIcon?.classList.add("sticky-icon");
        } else {
          navbar?.classList.remove("sticky");
          navLinks.forEach((link) =>
            (link as HTMLElement).classList.remove("sticky-link")
          );
    ...
    const initializeStickyBar = () => {
      const stickyData = document.getElementById(
        "stickyData"
      ) as HTMLDivElement;
  ...
  return (
    <RouteTransition>
      <ScrollToTop />
      <div className="levisxappeal-page">
        ...
        <section className="byoma-banner">
          <iframe
            src="https://player.vimeo.com/video/779228832?h=948fa7899f&badge=0&autopause=0&player_id=0&app_id=58479"
            frameBorder="0"
        ...
        <section className="image-banner">
          <div className="image-wrapper">
            <img
              src="http://localhost:1337/uploads/middle_image_dc79047aae.webp"
              alt="Floral Cups"
        ...
        <section className="project-datas">
          <div className="project-datas__column project-datas__image">
            <img
              src="http://localhost:1337/uploads/layout_image_0d4e7bb995.webp"
              alt="Butterfly Cup"
            />
          </div>
        ...
        <section className="image-banner">
          <div className="image-wrapper">
            <img
              src="http://localhost:1337/uploads/middle_image2_dccc4d8a8c.webp"
              alt="Floral Cups"
              className="banner-img"
            />
          </div>
        ...
        <section className="project-intro">
          ...
          <div className="project-intro__column project-intro__image">
            <img
              src="http://localhost:1337/uploads/layout_image_2_f2bde566c5.webp"
        ...
        <section className="image-banner">
          <div className="image-wrapper">
            <img
              src="http://localhost:1337/uploads/middle_image3_13c21e3d54.webp"
              alt="Floral Cups"
              className="banner-img"
            />
          </div>
...
export default LevisxappealPage;
