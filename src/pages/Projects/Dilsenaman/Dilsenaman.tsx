...
import "./Dilsenaman.css";

const Dilsenaman: React.FC = () => {
  useEffect(() => {
    ...
    const initializeStickyBar = () => {
      const stickyData = document.getElementById("stickyData") as HTMLElement;
  ...
  return (
    <>
      ...
      <section className="byoma-banner">
        <iframe
          src="https://player.vimeo.com/video/783595880?h=64abe5e0e8&badge=0&autopause=0&player_id=0&app_id=58479"
          frameBorder="0"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image3_481c916312.webp"
            alt="Floral Cups"
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image_8206c96655.webp"
        ...
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layout_image2_2c3fef6384.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image2_f13821b7fb.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image_1fbd2f9714.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
