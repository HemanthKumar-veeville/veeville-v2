...
const Karnataka: React.FC = () => {
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener("scroll", initializeStickyBar);
    };
  }, []);
  ...
  return (
    <>
      ...
      <section className="stamina-banner">
        <img
          src="http://localhost:1337/uploads/Top_01_1005bd9a8a.webp"
          alt="Banner Image"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/Middle_02_17f835fc9b.webp"
            alt="Floral Cups"
      ...
      <section className="project-intro">
        ...
        <div className="project-intro__column project-intro__image">
          <img
            src="http://localhost:1337/uploads/Karnaatka_Advancing_07_30fd8c046a.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/Middle_03_8526756215.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/Bottom_2_82fcf50e32.webp"
        ...
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/Bottom_3_2c1ddb9014.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/Middle_04_67f1dcb6de.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
