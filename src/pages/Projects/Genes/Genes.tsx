...
const Genes: React.FC = () => {
  useEffect(() => {
    ...
    // Initialize card carousel functionality
    const initializeCardCarousel = () => {
      ...
      const carouselInterval = setInterval(scrollNext, scrollInterval);
  ...
  return (
    <>
      ...
      <section className="stamina-banner">
        <img
          src="http://localhost:1337/uploads/banner_beee63dcbf.webp"
          alt="Banner Image"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image_f0609bcf2f.webp"
            alt="Floral Cups"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middle_image2_1ba5e7db75.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-datas">
        <div className="project-datas__column project-datas__image">
          <img
            src="http://localhost:1337/uploads/layoutimage_16ecc85896.webp"
            alt="Butterfly Cup"
          />
        </div>
      ...
      <section className="project-images">
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layoutimage2_bd7c0d532a.webp"
        ...
        <div className="project-images__column">
          <img
            src="http://localhost:1337/uploads/layoutimage3_2a8e290048.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middleimage4_cd1e79bc1a.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middleimage3_65469b5dd1.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-intro">
        ...
        <div className="project-intro__column project-intro__image">
          <img
            src="http://localhost:1337/uploads/layoutimage4_d8e52917db.webp"
      ...
      <section className="image-banner">
        <div className="image-wrapper">
          <img
            src="http://localhost:1337/uploads/middleimage5_0d2ef8b6b8.webp"
            alt="Floral Cups"
            className="banner-img"
          />
        </div>
      ...
      <section className="project-navigation-section">
        ...
        <div className="project-navigation">
          <Link to="/projects/karnataka" className="prev-project">
            Previous Project
          </Link>
